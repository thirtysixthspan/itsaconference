...
class Admin::QuestionsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Question: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Question: create, read, update, custom_action_for_an_item
  #
