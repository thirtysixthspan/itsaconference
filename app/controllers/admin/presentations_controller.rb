...
class Admin::PresentationsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Presentation: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Presentation: create, read, update, custom_action_for_an_item
  #
