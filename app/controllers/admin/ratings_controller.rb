...
class Admin::RatingsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Rating: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Rating: create, read, update, custom_action_for_an_item
  #
