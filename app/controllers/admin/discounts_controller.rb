...
class Admin::DiscountsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Discount: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Discount: create, read, update, custom_action_for_an_item
  #
