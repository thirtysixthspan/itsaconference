...
class Admin::ResponsesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Response: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Response: create, read, update, custom_action_for_an_item
  #
