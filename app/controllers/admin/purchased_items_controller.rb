...
class Admin::PurchasedItemsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     PurchasedItem: create, read, update, destroy, custom_action
  #
  #   editor:
  #     PurchasedItem: create, read, update, custom_action_for_an_item
  #
